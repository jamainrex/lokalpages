...
?>
				...
				<div id="ait-clone-form_controls">
					<a id="ait-clone-form_add" class="button-primary"><?php _e('Add Business', 'ait') ?></a>
					<a id="ait-clone-form_remove_last" class="button-secondary"><?php _e('Remove last business', 'ait') ?></a>
					<a id="ait-clone-form_remove_all" class="button-secondary"><?php _e('Remove all businesses', 'ait') ?></a>
