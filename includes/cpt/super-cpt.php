...
class Super_CPT {
	...
	function load_js_and_css() {
		wp_register_style( 'supercpt.css', get_stylesheet_directory_uri() . '/includes/cpt/css/supercpt.css', array(), '1.3' );
		wp_register_script( 'supercpt.js', get_stylesheet_directory_uri() . '/includes/cpt/js/supercpt.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-datepicker' ), '1.1' );
